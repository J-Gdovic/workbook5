...
//   }
// }
const coursesTitles = courses.filter((titleOfcourse) => titleOfcourse.Location == "Classroom 1");
coursesTitles.forEach(titleOfcourse => console.log(titleOfcourse.Title));
